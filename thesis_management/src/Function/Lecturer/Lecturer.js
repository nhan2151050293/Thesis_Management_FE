...
const Lecturers = () => {
    ...
    const handleUpdateLecturer = async () => {
        try {
            ...
            await api.patch(endpoints['update-lecturer'](selectedLecturer.user), formData, {
                headers: {
    ...
    const handleAddLecturer = async () => {
        ...
        try {
            ...
            console.error('Lỗi thêm giảng viên:', error.response?.data || error.message);
            if (error.response?.data) {
                console.error('Chi tiết lỗi từ server:', error.response.data);
            }
            alert('Thêm giảng viên thất bại. Vui lòng kiểm tra lại dữ liệu và thử lại.');
        }
    };
                    ...
                    <Form>
                        ...
                        <Form.Group controlId="formCode">
                            ...
                            <Form.Control
                                ...
                                onChange={(e) => setNewLecturer({ ...newLecturer, code: e.target.value })}
                            />
                        </Form.Group>
                        <Form.Group controlId="formFullName">
                            <Form.Label>Họ và tên</Form.Label>
                        ...
                        <Form.Group controlId="formBirthday">
                            ...
                            <Form.Control
                                ...
                                onChange={(e) => setNewLecturer({ ...newLecturer, birthday: e.target.value })}
                            />
                        </Form.Group>
                        <Form.Group controlId="formAddress">
                            <Form.Label>Quê quán</Form.Label>
